...
/**
 * Chapeau mark — the flowing "C" curve from the supplied brand SVG,
 * paired with the wordmark set in the brand sans. `currentColor` lets it
 * invert cleanly on charcoal footers/CTAs.
 */
export function Logo({
  ...
  return (
    <span className={cn("inline-flex items-center gap-2.5", className)}>
      ...
      {showWordmark && (
        <span className="text-[1.05em] font-semibold tracking-[-0.03em]">
          Chapeau
        </span>
      )}
    </span>
