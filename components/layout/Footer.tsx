    ...
    <footer className="bg-charcoal text-white">
      ...
      <div className="shell grid gap-12 py-16 md:grid-cols-12 md:py-20">
        <div className="md:col-span-5">
          <Link href="/" aria-label="Chapeau home" className="text-white">
        ...
        >
          <p className="label text-[0.72rem] text-teal-400">Navigate</p>
        ...
        <div className="md:col-span-3">
          <p className="label text-[0.72rem] text-teal-400">Get in touch</p>
          <ul className="mt-5 space-y-3">
            <li>
              <a
      ...
      <div className="border-t border-white/10">
        <div className="shell flex flex-col gap-2 py-6 text-[0.8rem] text-white/40 sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {new Date().getFullYear()} {site.name}. All rights reserved.
          </p>
          <p className="label text-[0.7rem] tracking-label text-white/35">
