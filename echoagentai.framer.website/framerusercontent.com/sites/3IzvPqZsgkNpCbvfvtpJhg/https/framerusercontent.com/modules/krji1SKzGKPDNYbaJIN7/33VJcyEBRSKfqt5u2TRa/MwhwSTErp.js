...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    const href = useSVGTemplate("3416321359", svg);
    return /*#__PURE__*/ _jsx(SVG, { ...restProps,
        className: cx("framer-wOUd9", className),
        layoutId: layoutId,
        ref: ref,
        role: "presentation",
        style: {
...
const css = [`.framer-wOUd9 { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`];
/**
 ...
 * @framerVector {"name":"Linkedin","color":{"type":"variable","value":"1m973uw"},"set":{"localId":"vectorSet/ZsiCCGPvG","id":"ZsiCCGPvG","moduleId":"Y7SpbVH16cWqMhj75z1M"}}
 */
const Icon = withCSS(Component, css, "framer-wOUd9");
