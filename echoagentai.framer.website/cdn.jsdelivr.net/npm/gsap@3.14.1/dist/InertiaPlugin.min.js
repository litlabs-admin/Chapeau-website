...
! function(t, e) {
    ...
    function u(t, e, r, i) {
        this.t = t, this.p = e, this.g = t._gsap.get, this.rCap = v[r || n(this.g(t, e))], this.v1 = this.v2 = this.g(t, e), this.t1 = this.t2 = a.time, i && ((this._next = i)._prev = this)
    }
    var i, l, g, n, o, a, s, c, f = {},
        ...
        d = function() {
            ...
            return e.get = function get(t, e) {
                ...
                var i = this._props[t];
                i ? (i.v1 = i.v2 = i.g(i.t, i.p), i.t1 = i.t2 = a.time) : (o || (a.add(r), s = a.time), o = this._props[t] = new u(this.target, t, e, o))
